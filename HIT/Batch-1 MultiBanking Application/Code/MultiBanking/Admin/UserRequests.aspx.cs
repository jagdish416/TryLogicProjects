...
public partial class Admin_UserRequests : System.Web.UI.Page
{
   ...
   public void load()
   {
       string qry = "select * from Customer where Status='pending'";
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            string qry = " Update Customer Set Status ='Active' where CustomerId='" + lbl1.Text + "'";
    ...
    protected void Button2_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            GridViewRow gr = (GridViewRow)btn.NamingContainer;
            Label lbl1 = (Label)gr.FindControl("Label2");
            string qry = "Delete from Customer where CustomerId='" + lbl1.Text + "'";
            int i = obj.InUpDel(qry);
            if (i > 0)
            {
