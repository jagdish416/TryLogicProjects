<%@ Page Title="" Language="C#" MasterPageFile="~/User/Usermain.master" AutoEventWireup="true" CodeFile="Profile.aspx.cs" Inherits="User_Profile" %>
...
<td>
 <asp:TextBox ID="txtpas" runat="server" Width="141px" ReadOnly="true" Font-Size="Large"></asp:TextBox>
    ...
    <asp:LinkButton ID="LinkButton1" runat="server" Font-Size="Large" 
        ForeColor="Red" onclick="LinkButton1_Click">Change</asp:LinkButton>   
</td>
</tr>
...
<td>
 <asp:TextBox ID="txtmobile" runat="server" Width="141px" ReadOnly="true" Font-Size="Large"></asp:TextBox>
     <asp:LinkButton ID="LinkButton2" runat="server" Font-Size="Large" 
        ForeColor="Red" onclick="LinkButton2_Click">Change</asp:LinkButton>   
</td>
</tr>
<tr>
<td align="center">
...
<td>
    ...
    <asp:LinkButton ID="LinkButton4" runat="server" Font-Size="Large" 
        ForeColor="Red" onclick="LinkButton4_Click">Change</asp:LinkButton> 
</td>
</tr>
...
<tr>
<td align="center" style="width: 526px">
    <asp:Label ID="Label9" runat="server" Text="Country :" Font-Size="Large"></asp:Label>
</td>
<td>
 <asp:TextBox ID="txtcountry" runat="server" Width="141px" ReadOnly="true" Font-Size="Large"></asp:TextBox>
...
<tr>
<td align="center" style="width: 526px">
    <asp:Label ID="Label11" runat="server" Text="Latitude :" Font-Size="Large"></asp:Label>
</td>
<td>
 <asp:TextBox ID="txtlat" runat="server" Width="141px" ReadOnly="true" Font-Size="Large"></asp:TextBox>
    <asp:LinkButton ID="LinkButton5" runat="server" Font-Size="Large" 
        ForeColor="Red" onclick="LinkButton5_Click">Change</asp:LinkButton> 
</td>
</tr>
<tr>
<td align="center" style="width: 526px">
    <asp:Label ID="Label12" runat="server" Text="Longitude :" Font-Size="Large"></asp:Label>
</td>
<td>
 <asp:TextBox ID="txtlong" runat="server" Width="141px" ReadOnly="true" Font-Size="Large"></asp:TextBox>
    <asp:LinkButton ID="LinkButton6" runat="server" Font-Size="Large" 
        ForeColor="Red" onclick="LinkButton6_Click">Change</asp:LinkButton> 
</td>
</tr>
<tr><td></td></tr>
<tr>
<td align="center" colspan="2">
    <asp:ImageButton ID="ImageButton1" runat="server" 
        ImageUrl="~/prjmmg/update-hi.png" Height="40px" Width="135px" 
